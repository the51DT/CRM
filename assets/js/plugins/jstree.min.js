        ...
        delete_node: function (b) {
          ...
          for (
            ...
            this._model.data[g[j]].state.selected &&
              ...
              -1 !== f &&
                (this._data.core.selected = a.vakata.array_remove(this._data.core.selected, f)));
          }
          for (
        ...
        (a.vakata.context = {
          ...
          _show_submenu: function (c) {
            if (((c = a(c)), c.length && c.children("ul").length)) {
              ...
              b
                ? c[e - (g + 10 + c.outerWidth()) < 0 ? "addClass" : "removeClass"](
                    "vakata-context-left"
                  )
        ...
        a.vakata.dnd = {
          ...
          start: function (c, d, e) {
            ...
            return (
              ...
              e !== !1 &&
                (b.helper = a("<div id='vakata-dnd'></div>").html(e).css({
                  display: "block",
                  margin: "0",
                  padding: "0",
                  position: "absolute",
